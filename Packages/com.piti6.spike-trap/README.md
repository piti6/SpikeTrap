...
`SpikeTrapAPI` provides static methods for programmatic control — designed for AI agents (uLoop MCP) and editor scripts.
...
Run via Unity Test Runner (EditMode, assembly `SpikeTrap.Tests`).
