...
namespace SpikeTrap.Editor
{
    internal sealed class SpikeTrapViewController : ProfilerModuleViewController
    {
        ...
        internal static volatile int s_CurrentSessionId;
        ...
        public SpikeTrapViewController(ProfilerWindow profilerWindow)
            : base(profilerWindow)
        {
        ...
        {
            return new SpikeTrapViewController(profilerWindow);
        }
