            ...
            if (m_DetailedPanelType != DetailedPanelType.None && isDataAvailable)
            {
                ...
                GUILayout.Label(
                    m_DetailedPanelType == DetailedPanelType.RelatedData
                        ? "Related Data panel: use Unity Editor Profiler for full object linkage, or extend SpikeTrap."
                        : "Calls panel: use Unity Editor Profiler for full caller/callee data, or extend SpikeTrap.",
